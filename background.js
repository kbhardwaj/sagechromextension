...
chrome.browserAction.onClicked.addListener(function() {
    chrome.tabs.executeScript(null, {file:"scripts/jquery-1.7.2.min.js"}, function() {
    	chrome.tabs.executeScript(null, {file:"scripts/wysihtml5-0.3.0.js"}, function() {
    		chrome.tabs.executeScript(null, {file:"scripts/bootstrap.min.js"}, function() {
    			chrome.tabs.executeScript(null, {file:"scripts/bootstrap-wysihtml5.js"}, function(){
    				chrome.tabs.insertCSS(null, {file:"styles/bootstrap-wysihtml5.css"}, function() {
    					// chrome.tabs.insertCSS(null, {file:"styles/wysywyg-color.css"}, function() {
    						chrome.tabs.insertCSS(null, {file:"sm.css"}, function() {
...
//     var nbooks = document.getElementsByTagName("body")[0];
